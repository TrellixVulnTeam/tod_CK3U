...
class WAConnection extends events_1.EventEmitter {
    constructor() {
        ...
        this.loadProfilePicturesForChatsAutomatically = true;
         ...
         */
        this.fetchRequest = (endpoint, method = 'GET', body, agent, headers) => (node_fetch_1.default(endpoint, {
            method,
            body,
     ...
     */
    async waitForMessage(tag, json, requiresPhoneConnection, timeoutMs) {
    ...
    startDebouncedTimeout() {
        ...
        this.debounceTimeout = setTimeout(() => this.emit('ws-close', { reason: Constants_1.DisconnectReason.timedOut }), this.connectOptions.maxIdleTimeMs);
    }
    stopDebouncedTimeout() {
    ...
    endConnection() {
        ...
        this.emit('ws-close', { reason: Constants_1.DisconnectReason.close });
