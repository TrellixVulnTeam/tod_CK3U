...
exports.waChatKey = (pin) => ({
    key: (c) => (pin ? (c.pin ? '1' : '0') : '') + c.t.toString(16).padStart(8, '0') + c.jid,
...
exports.WA_MESSAGE_ID = (m) => exports.GET_MESSAGE_ID(m.key);
exports.GET_MESSAGE_ID = (key) => `${key.id}|${key.fromMe ? 1 : 0}`;
exports.whatsappID = (jid) => jid === null || jid === void 0 ? void 0 : jid.replace('@c.us', '@s.whatsapp.net');
exports.isGroupID = (jid) => jid === null || jid === void 0 ? void 0 : jid.endsWith('@g.us');
exports.newMessagesDB = (messages = []) => {
...
exports.mediaMessageSHA256B64 = (message) => {
