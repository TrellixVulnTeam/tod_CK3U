...
import { WAMessageStatusUpdate, WAMessage, WAChat, WA_MESSAGE_STATUS_TYPE, PresenceUpdate, BaileysEvent, DisconnectReason, WAOpenResult, AuthenticationCredentials, WAParticipantAction, WAGroupMetadata, WAUser } from './Constants';
export declare class WAConnection extends Base {
    ...
    on(event: 'chats-update', listener: (chats: (Partial<WAChat> & {
        jid: string;
    })[]) => void): this;
